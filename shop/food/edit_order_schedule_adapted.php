  ...
  <div id="main_content">
    <form name="edit_schedule" id="edit_schedule" action="'.$_SERVER['SCRIPT_NAME'].'" method="POST">
      ...
      <fieldset class="controls">
        '.($show_new_button == true ? '<input type="submit" id="action_add_new" name="action" value="Commit this new cycle">' : '').'
        '.($show_delete_button == true ? '<input type="submit" id="action_delete" name="action" form="null" value="Delete">' : '').'
        '.($show_update_button == true ? '<input type="submit" id="action_update" name="action" value="edit old cycle">' : '').'
