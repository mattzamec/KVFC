...
<div id="main_content">
  <fieldset class="controls">
    <div id="pager" class="internal">
      ...
      <span id="data_page" onkeyup="constrain(\'data_page\', jQuery(\'#this_page\').val());debounce_pager(\'data_page\', jQuery(\'#this_page\').val());" onchange="constrain(\'data_page\', jQuery(\'#this_page\').val());debounce_pager(\'data_page\', jQuery(\'#this_page\').val());" onfocus="document.execCommand(\'selectAll\',false,null)" contenteditable>'.$data_page.'</span>
      <div id="maximum_data_page">/ '.$found_pages.'</div>
