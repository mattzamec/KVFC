...
$display_route = '
   ...
   <tr valign="top">
      <td align="left" width="50%">
        ...
        <ul class="fancyList1">
          ...
          <li> <a href="delivery_list_all.php?delivery_id='.$delivery_id.'">All members with orders on each route</a>
          <li><a href="route_list.php?delivery_id='.$delivery_id.'&type=pickup">Producer Pick-up List</a></li>
          <li class="last_of_group"><a href="route_list.php?delivery_id='.$delivery_id.'&type=dropoff">Site Drop-off List</a></li>
      ...
      <td align="left" width="50%">
        ...
        <ul class="fancyList1">
          <li><a href="orders_list_withtotals.php?delivery_id='.$delivery_id.'">Customer orders with totals</a></li>
          <li><a href="producer_list_withtotals.php?delivery_id='.$delivery_id.'">Producer orders with totals</a></li>
          <li><a href="members_list_emailorders.php?delivery_id='.$delivery_id.'">Customer Email Addresses this cycle</a></li>
          <li><a href="orders_prdcr_list.php?delivery_id='.$delivery_id.'">Producers with Customers this Cycle</a></li>
        </ul>
      </td>
    </tr>
  </table>';
  $sqla = '
    SELECT
      ...
      admin
    FROM '.TABLE_ROUTE.'
    WHERE rtemgr_member_id = "'.mysql_real_escape_string ($_SESSION['member_id']).'"
    AND admin != "1"';
