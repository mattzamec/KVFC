...
{ 
    return '<br><br><center style="color:#f00;letter-spacing:5px;">** FEATURED WHOLESALE ITEM **</center>';
}
...
{ 
    return
        ...
        'You will be billed for exact '.$data['meat_weight_type'].' weight ('.
...
{ 
    return '<table id="product_list_table">';
}
    ...
    switch ($minor_division)
    {
        ...
        case 'producer_name':
          $header = '
            <tr>
              <td colspan="6" class="header_minor">
                <a href='.$_SERVER['SCRIPT_NAME'].'?type=producer_link&producer_link='.$data['producer_link'].'>'.$data['producer_name'].'</a>
              </td>
            </tr>';
          break;
