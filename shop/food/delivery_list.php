...
if (isset($_GET['route_id']) && !empty($_GET['route_id'])) $route_id = $_GET['route_id'];
else $route_id = 1;
...
$content_delivery = '
<div align="center">
' . delivery_nav($_SERVER['SCRIPT_NAME'].'?route_id='.$route_id.'&site_id='.$site_id.'&delivery_id=', $delivery_id).'
...
$page_specific_css = '
  <link rel="stylesheet" type="text/css" href="delivery_nav.css">';
