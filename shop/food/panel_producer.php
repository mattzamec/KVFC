...
if ($_SESSION['producer_id_you'])
  {
    $display .= '
        ...
        <ul class="fancyList1">
          ...
          <ul class="fancyList1">
            <li><a href="product_list.php?a=all&type=producer_list">Show all products</a></li>
            <li><a href="product_list.php?a=retail&type=producer_list">Show products listed for retail</a></li>
            <!-- <li><a href="product_list.php?a=wholesale&type=producer_list">Listed&nbsp;Wholesale</a></li> -->
            <li><a href="product_list.php?a=unlisted&type=producer_list">Show unlisted products</a></li>
            <li class="last_of_group"><a href="product_list.php?a=archived&type=producer_list">Show archived products</a></li>
